...
const _getProfile = (oeEntityCode, targetDateStr, profileType) => {
  if (!targetDateStr) {
  ...
  return _demandProfileApi.oeHttpApi.axios.get(`/demand-profiles/${oeEntityCode}/${profileType}?start=${targetDateStr}`, _demandProfileApi.oeHttpApi.headers)
    .then(httpRes => {
...
_demandProfileApi.getActiveProfile = (oeEntityCode, targetDateStr) => {
  return _getProfile(oeEntityCode, targetDateStr, 'active');
};

_demandProfileApi.getDefaultProfile = (oeEntityCode, targetDateStr) => {
  return _getProfile(oeEntityCode, targetDateStr, 'default');
};
